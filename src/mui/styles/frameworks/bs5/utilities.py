...
class Spacing(Enum):
    ...
    PX1= f"px-1" # Padding on X-axis
    PX2= f"px-2" # Padding on X-axis
    PX3= f"px-3" # Padding on X-axis
    PX4= f"px-4" # Padding on X-axis
    PX5= f"px-5" # Padding on X-axis

    PY1 = f"py-1" # Padding on Y-axis
    PY2 = f"py-2" # Padding on Y-axis
    PY3 = f"py-3" # Padding on Y-axis
    PY4 = f"py-4" # Padding on Y-axis
    PY5 = f"py-5" # Padding on Y-axis

    PT1 = f"pt-1" # Padding Top
    PT2 = f"pt-2" # Padding Top
    PT3 = f"pt-3" # Padding Top
    PT4 = f"pt-4" # Padding Top
    PT5 = f"pt-5" # Padding Top

    PB1 = f"pb-1" # Padding Bottom
    PB2 = f"pb-2" # Padding Bottom
    PB3 = f"pb-3" # Padding Bottom
    PB4 = f"pb-4" # Padding Bottom
    PB5 = f"pb-5" # Padding Bottom

    PS1 = f"ps-1" # Padding Start (left in LTR)
    PS2 = f"ps-2" # Padding Start (left in LTR)
    PS3 = f"ps-3" # Padding Start (left in LTR)
    PS4 = f"ps-4" # Padding Start (left in LTR)
    PS5 = f"ps-5" # Padding Start (left in LTR)

    PE1 = f"pe-1" # Padding End (right in LTR)
    PE2 = f"pe-2" # Padding End (right in LTR)
    PE3 = f"pe-3" # Padding End (right in LTR)
    PE4 = f"pe-4" # Padding End (right in LTR)
    PE5 = f"pe-5" # Padding End (right in LTR)

    P1 = f"p-1"   # Padding all sides
    P2 = f"p-2"   # Padding all sides
    P3 = f"p-3"   # Padding all sides
    P4 = f"p-4"   # Padding all sides
    P5 = f"p-5"   # Padding all sides

    MX1 = f"mx-1" # Margin on X-axis
    MX2 = f"mx-2" # Margin on X-axis
    MX3 = f"mx-3" # Margin on X-axis
    MX4 = f"mx-4" # Margin on X-axis
    MX5 = f"mx-5" # Margin on X-axis
   
    MY1 = f"my-1" # Margin on Y-axis
    MY2 = f"my-2" # Margin on Y-axis
    MY3 = f"my-3" # Margin on Y-axis
    MY4 = f"my-4" # Margin on Y-axis
    MY5 = f"my-5" # Margin on Y-axis
   
    MT1 = f"mt-1" # Margin Top
    MT2 = f"mt-2" # Margin Top
    MT3 = f"mt-3" # Margin Top
    MT4 = f"mt-4" # Margin Top
    MT5 = f"mt-5" # Margin Top
   
    MB1 = f"mb-1" # Margin Bottom
    MB2 = f"mb-2" # Margin Bottom
    MB3 = f"mb-3" # Margin Bottom
    MB4 = f"mb-4" # Margin Bottom
    MB5 = f"mb-5" # Margin Bottom
   
    MS1 = f"ms-1" # Margin Start (left in LTR)
    MS2 = f"ms-2" # Margin Start (left in LTR)
    MS3 = f"ms-3" # Margin Start (left in LTR)
    MS4 = f"ms-4" # Margin Start (left in LTR)
    MS5 = f"ms-5" # Margin Start (left in LTR)
   
    ME1 = f"me-1" # Margin End (right in LTR)
    ME2 = f"me-2" # Margin End (right in LTR)
    ME3 = f"me-3" # Margin End (right in LTR)
    ME4 = f"me-4" # Margin End (right in LTR)
    ME5 = f"me-5" # Margin End (right in LTR)
   
    M1 = f"m-1"   # Margin all sides
    M2 = f"m-2"   # Margin all sides
    M3 = f"m-3"   # Margin all sides
    M4 = f"m-4"   # Margin all sides
    M5 = f"m-5"   # Margin all sides
...
class SpacingFunc:
    """Bootstrap Spacing utilities (margin and padding)."""
    @staticmethod
    def PX(self,value: int): return f"px-{value}" # Padding on X-axis
    @staticmethod
    def PY(self,value: int): return f"py-{value}" # Padding on Y-axis
    @staticmethod
    def PT(self,value: int): return f"pt-{value}" # Padding Top
    @staticmethod
    def PB(self,value: int): return f"pb-{value}" # Padding Bottom
    @staticmethod
    def PS(self,value: int): return f"ps-{value}" # Padding Start (self,left in LTR)
    @staticmethod
    def PE(self,value: int): return f"pe-{value}" # Padding End (self,right in LTR)
    @staticmethod
    def P(self,value: int): return f"p-{value}"   # Padding all sides
    @staticmethod
    def MX(self,value: int): return f"mx-{value}" # Margin on X-axis
    @staticmethod
    def MY(self,value: int): return f"my-{value}" # Margin on Y-axis
    @staticmethod
    def MT(self,value: int): return f"mt-{value}" # Margin Top
    @staticmethod
    def MB(self,value: int): return f"mb-{value}" # Margin Bottom
    @staticmethod
    def MS(self,value: int): return f"ms-{value}" # Margin Start (self,left in LTR)
    @staticmethod
    def ME(self,value: int): return f"me-{value}" # Margin End (self,right in LTR)
    @staticmethod
    def M(self,value: int): return f"m-{value}"   # Margin all sides
    @staticmethod
    def AUTO_MX(self,): return "mx-auto" # Center horizontally

class GridFunc:
    """Bootstrap Grid System classes."""
    @staticmethod
    def COL(self,value: int): return f"col-{value}"
    @staticmethod
    def COL_AUTO(self,): return "col-auto"
    @staticmethod
    def COL_SM(self,value: int): return f"col-sm-{value}"
    @staticmethod
    def COL_MD(self,value: int): return f"col-md-{value}"
    @staticmethod
    def COL_LG(self,value: int): return f"col-lg-{value}"
    @staticmethod
    def ROW(self,): return "row"
    @staticmethod
    def CONTAINER(self,): return "container"
    @staticmethod
    def CONTAINER_FLUID(self,): return "container-fluid"
