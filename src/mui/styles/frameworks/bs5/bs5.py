from mui.styles.frameworks.bs5.layout import Layout
from mui.styles.frameworks.bs5.typography import Typography
from mui.styles.frameworks.bs5.forms import Form
from mui.styles.frameworks.bs5.utilities import Utilities
from mui.styles.frameworks.bs5.extend import Extend
from mui.styles.frameworks.bs5.components.comp_enum import Components
...
class PropsProxy:
    ...
    def __getattr__(self, attr):
        ...
        enum_cls = og_attr if og_attr in self.enums else None #print(f'{og_attr} not fond in {self.enums}')
...
class BS5Element:
    ...
    """
    def __init__(self, tag: str, content: str = "", classes: Optional[list] = None, **attrs):
        self.tag = tag
        self.content = content
        # Ensure classes is a list, avoiding shared mutable defaults
        self.classes = [c for c in classes if c is not None] if classes is not None else []
        self.attrs = attrs
...
class BS5:
    ...
    def render(self,target_elemnt=None,)->str:
