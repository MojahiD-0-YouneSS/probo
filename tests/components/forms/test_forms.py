import pytest
from mui import MastodonForm, MastodonFormField
...
def test_declarative_form_style_1_variables():
    ...
    """
    # 1. Define Fields
    username_field = MastodonFormField(
        tag_name='input',
        field_label="Hello",
        name='username',
        value="258246413",
    ...
    password_field = MastodonFormField(
        tag_name='input',
...
def test_mff_builder_datalist():
    ...
    assert '<option value="Chrome"></option>' in html # Datalist options usually self-closing or empty content
