...
from mui.context.django import DjangoComponent, DjangoComponentTools
...
def test_comp_build_source_auto_compiles_vars(comp):
    ...
    comp.raw_template = "<$mui-var name='test'/>"
