---
name: "Doc Task: Standard Functional"
about: Good first issue to document Standard Functional tags
title: "[DOC Standard Functional] implement google style doc strings on probo/components/tag_functions/block_tags.py"
...
This issue involves updating the docstrings for a batch of standard functional HTML components located in `probo/components/tag_functions/`.
