---
name: "Doc Task: Standard OOP (Batch 1)"
about: Good first issue to document Standard OOP tags
title: "[DOC Standard OOP] implement google style doc strings on probo/components/tag_classes/block_tags.py (Batch 1)"
...
This issue involves updating the docstrings for the first batch of standard OOP HTML components located in `probo/components/tag_classes/block_tags.py`.
...
1. A brief description of the HTML element.
...
Please use this exact structure for all tags:
...
class A(BaseHTMLElement, ElementNodeMixin, ElementMutatorMixin):
    ...
    This component is used to create hyperlinked elements. It inherits core 
    functionalities from `BaseHTMLElement`, including robust attribute and inline 
    style management.
